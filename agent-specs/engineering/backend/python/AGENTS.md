...
## Overview
- Build reliable backend services in Python with clear and maintainable code.
...
6. Security and privacy are defaults, not add-ons.
   - Master/Source: General practice.
...
7. Compatibility is a promise; break it rarely and deliberately.
   - Master/Source: General practice.
   - Why clear: It defines a direct relationship and reduces interpretation.
   - Use when: When decisions depend on the principle.
8. Optimize with evidence, not intuition.
   - Master/Source: General practice.
   - Why clear: It makes the preferred basis explicit and sets a boundary.
   - Use when: When balancing two competing bases for a decision.
9. Automate routine work to reduce toil.
   - Master/Source: General practice.
...
6. Prefer the standard library and mature packages.
...
7. Use type hints and linters for clarity.
   - Why: Improves readability and catches issues early.
   - How: Add type hints and run linters in CI.
   - Check: Type checks and linting pass without warnings.
