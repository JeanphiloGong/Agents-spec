...
This package contains skills for turning engineering work into durable,
reader-friendly communication artifacts.
...
`$html-report-review` when the artifact is a browser-playable report deck. Use
