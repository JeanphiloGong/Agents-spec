...
7. Bound goroutines and network connections.
   - Why: Prevents resource leaks and instability under load.
   - How: Use contexts, worker pools, and bounded concurrency.
   - Check: Goroutine counts remain stable under load.
