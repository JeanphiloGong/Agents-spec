# Split Parent Doc Rules

Use this reference when a parent doc keeps growing with local child detail.
...
Split before the parent becomes the only durable home of child detail.
